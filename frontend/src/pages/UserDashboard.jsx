    ...
    <div className="dashboard-container">
      ...
      <aside className={`sidebar ${isSidebarOpen ? "sidebar-open" : ""}`}>
        ...
        <nav className="nav-links">
          ...
          <a className="nav-item" onClick={() => navigate('/user-profile')} style={{ cursor: 'pointer' }}>
        ...
        <main className="main-content">
          <header className="header">
            ...
            <div className="header-actions">
              ...
              <div className="user-avatar" onClick={() => navigate('/user-profile')} style={{ cursor: 'pointer' }}>
                <img
          ...
          <div className="bento-grid">
            {/* Quick Edit Card */}
            <div className="card quick-action-card" onClick={() => navigate("/profile-editor")}>
